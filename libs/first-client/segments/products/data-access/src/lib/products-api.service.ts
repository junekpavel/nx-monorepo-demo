...
export class ProductsApiService {
  constructor(
    ...
    @Inject(PRODUCTS_RESOURCE_CONFIGURATION)
    private readonly resourceConfiguration: ProductsResourceConfiguration,
  ) {}

  getAll(): Observable<Product[]> {
    return this.httpClient
      .get<{ data: Product[] }>(
        this.resourceConfiguration.productsApiResourceUrl,
      )
      .pipe(pluck("data"), delay(500));
  }
