...
export class ProductDetailPageComponent {
  ...
  readonly product$: Observable<Product | undefined> = this.activatedRoute.paramMap
    .pipe(
      map(paramMap => paramMap.get('productId')),
      switchMap((productId: string | null) => productId ? this.productsApiService.getSingle(+productId) : of(undefined)),
